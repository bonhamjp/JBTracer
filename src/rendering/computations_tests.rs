...
mod tests {
  ...
  fn new_computation_holds_computed_state_of_intersection() {
    ...
    let intersection = Intersection::new(4.0, &sphere, Matrix4x4::identity(), Matrix4x4::identity());
  ...
  fn new_computation_from_object_with_interpolated_normals_calculates_normal() {
    ...
    let intersection = Intersection::new_with_uv(1.0, &smooth_triangle, Matrix4x4::identity(), Matrix4x4::identity(), 0.45, 0.25);
    let mut intersections = Vec::new();
    intersections.push(intersection);
  ...
  fn computed_hit_from_inside_of_object() {
    ...
    let intersection = Intersection::new(4.0, &sphere, world_to_object, normal_to_world);
    let mut intersections = Vec::new();
    intersections.push(intersection);
  ...
  fn computed_hit_from_outside_of_object() {
    ...
    let intersection = Intersection::new(1.0, &sphere, Matrix4x4::identity(), Matrix4x4::identity());
    let mut intersections = Vec::new();
    intersections.push(intersection);
  ...
  fn over_point_slightly_above_hit_is_computed() {
    ...
    let intersection = Intersection::new(5.0, &sphere, Matrix4x4::identity(), Matrix4x4::identity());
    let mut intersections = Vec::new();
    intersections.push(intersection);
  ...
  fn computations_do_not_compute_reflection_vector_for_non_reflective_objects() {
    ...
    let intersection = Intersection::new((2.0 as f64).sqrt(), &plane, Matrix4x4::identity(), Matrix4x4::identity());
    let mut intersections = Vec::new();
    intersections.push(intersection);
  ...
  fn calculating_n1_and_n2_values_at_intersections() {
    ...
    let intersection_1 = Intersection::new(2.0, &sphere_1, Matrix4x4::identity(), Matrix4x4::identity());
    let intersection_2 = Intersection::new(2.75, &sphere_2, Matrix4x4::identity(), Matrix4x4::identity());
    let intersection_3 = Intersection::new(3.25, &sphere_3, Matrix4x4::identity(), Matrix4x4::identity());
    let intersection_4 = Intersection::new(4.75, &sphere_2, Matrix4x4::identity(), Matrix4x4::identity());
    let intersection_5 = Intersection::new(5.25, &sphere_3, Matrix4x4::identity(), Matrix4x4::identity());
    let intersection_6 = Intersection::new(6.0, &sphere_1, Matrix4x4::identity(), Matrix4x4::identity());
    let mut intersections = Vec::new();
